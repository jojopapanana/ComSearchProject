        ...
        <div class="col-3 rounded mb-5" style="height: 40vh">
            ...
            <div class="h-60 rounded-bottom p-3" style="background-color: rgba(218, 226, 182, 1)">
                ...
                <div class="d-flex justify-content-center gap-4">
                    ...
                    @else
                        <a href="" class="btn fw-semibold p-2 ps-4 pe-4 w-75 text-center" style="background-color: rgba(183, 207, 91, 1); border-radius: 40px; color: black;" id="greenbutton">testes</a>
                    @endif
                </div>
            </div>
        </div>
