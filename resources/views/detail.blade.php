      ...
      <div class="d-flex pt-3 ps-4">
        ...
        <div style="width: 50vw">
          ...
          <div class="d-flex justify-content-center gap-4">
              @if(Carbon\Carbon::now() >= $event->registration_start_date && Carbon\Carbon::now() <= $event->registration_end_date)
                <a href="{{ URL::to('registration/' . $event->id) }}" class="btn shadow-sm fw-semibold p-2 ps-4 pe-4" style="margin-top: 30px; background-color: rgba(183, 207, 91, 1); border-radius: 40px; width: 100%; color: black;">Register</a>
              @else
