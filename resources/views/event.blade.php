<x-layout title="My Event">
    ...
    <div class="p-5">
            ...
            <div class="row mb-2">
                ...
                <div class="col-3 rounded mb-5" style="height: 40vh">
                    <div class="h-50 rounded-top" style="background-color: gray">
                        <img src="/storage/images/events/{{ $event->thumbnail }}" alt="EVENT" class="rounded-top h-100 w-100">
                    </div>
        ...
        @else
            ...
            <div class="d-flex justify-content-center">
                <a href="{{ route('dashboard') }}" class="btn fw-semibold p-2 ps-4 pe-4 shadow" style="background-color: rgba(183, 207, 91, 1); border-radius: 40px; color: black;" id="greenbutton">Look for Events</a>
            </div>
        @endif
    </div>
</x-layout>