<div class="d-flex pb-5" style="background-color: #CCD6A6">
        ...
        <div class="align-self-center col-3" style="font-size: 0.9rem; font-weight:bold">
            ...
            <div class="ps-4 m-3">Privacy Policy</div>
            <div class="ps-4 m-3">Terms Of Service</div>
            <div class="ps-4 m-3">Cookies</div>
        </div>
        <div class="align-self-center col-3" style="font-size: 0.9rem">
            <div class="ps-1 ms-5" style="font-weight:bold">Follow Us</div>
            <div class="ps-1 ms-5 d-flex align-items-center" >
                <div class="me-2 bi bi-instagram" style="font-size: 1.5rem"></div>
                <div class="">@comsearch</div>
            </div>
            <div class="ps-1 ms-5 d-flex align-items-center">
                <div class="me-2 bi bi-facebook" style="font-size: 1.5rem"></div>
                <div class="">@comsearch</div>
            </div>
            <div class="ps-1 ms-5 d-flex align-items-center">
                <div class="me-2 bi bi-twitter" style="font-size: 1.5rem"></div>
                <div class="">@comsearch</div>
            </div>
        </div>
    </div>